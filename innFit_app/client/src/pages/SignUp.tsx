...
export default function SignUp({ onCreateAccount, onLogin, onBack }: SignUpProps) {
  ...
  const isFormValid = email.trim().length > 0 && password.trim().length > 0 && confirmPassword.trim().length > 0;
      ...
      <div className="flex-1 container-responsive flex flex-col">
        <div className="mb-6">
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="font-['Montserrat',Helvetica] text-xs text-blue-800">
              <span className="font-semibold">Demo Email:</span> innfit@gmail.com<br />
              <span className="font-semibold">Demo Password:</span> 1234
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 flex-1 flex flex-col">
          ...
          <p className="font-['Montserrat',Helvetica] text-xs text-[#676767]">
            By clicking the <span className="text-[#ff4b26] font-semibold">Register</span> button, you agree to the public offer
          </p>
          ...
          <div className="space-y-5 pb-6">
            ...
            <p className="text-center font-['Montserrat',Helvetica] text-sm text-[#575757]">
              ...
              <button onClick={onLogin} className="text-[#0088ff] font-semibold underline hover:opacity-70 active:opacity-50 transition-opacity duration-200">
                Login
              </button>
            </p>
          </div>
